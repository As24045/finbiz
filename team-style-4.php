...
<!-- Mirrored from reactheme.com/products/html/finbiz/team-style-4.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2023 16:15:44 GMT -->
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Finbiz Team Style 4 (Business Consultant)</title>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 breadcrumb-1">
                    <h1 class="title">Team Style 4</h1>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="bread-tag">
                        <a href="index-2.php">Home</a>
                        <span> / </span>
                        <a href="#" class="active">Team Style 4</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-5 mt--20 mt_md--30 mt_sm--0">
                <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                    <div class="team-inner-two inner">
                        <a href="team-details.php" class="thumbnail">
                        ...
                        <div class="acquaintance-area">
                            ...
                            <p class="team-desc">
                                Vehicula duis tempus vel porttitor lacus morbi pharetra neque, pretium ad enim urna ridiculus nibh, mus class arcu magna ornare orci mollis. Posuere quam eget non mollis platea.
                            </p>
